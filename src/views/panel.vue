<template>
    <div  class="g-sidenav-show  bg-gray-100" id="home">
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold"> <!--{{auth.user.name}}!--> Platform</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav" >
        ...
        <li class="nav-item">
          <router-link v-bind:class="'nav-link '+ reservar"  to="/panel/reservar">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol  class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a   @click="back()" class="opacity-5 text-dark">Atras</a ></li>
            <li  class="breadcrumb-item text-sm text-dark active" aria-current="page">{{this.$router.currentRoute._rawValue.name}}</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">{{this.$router.currentRoute._rawValue.name}}</h6>
        </nav>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span @click="logout()" class="d-sm-inline d-none">Cerrar Sesion</span>
              </a>
            </li>
...
export default {
  ...
  //      navbar
    ...
    prestamos(){
      ...
      reservar(){
        if(this.$store.state.rutas.reservar){
          return "active"
        }
        return ""
